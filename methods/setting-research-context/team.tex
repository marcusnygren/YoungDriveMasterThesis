...
It is needed to take on several roles in the project: most notably that of a designer, developer, but also product owner. It is needed to balance all different opinions and requirements, caring for the vision (like mentioned in the chapter "A good designer") \todo{Add reference}. The motivation doing the master thesis is three-fold: learn as much as possible, create a successful project, and finish the master thesis.
