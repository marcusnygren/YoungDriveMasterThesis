...
\section{Demonstrated how Certain Technical Constraints and Design Constraints can be Overcome in a Developing World Context} % service design in development environments % Designprocessen, frågeställning 1
...
\section{Provided Methods of Investigating Usability and Learnings with a Digital Training Tool in the Real-World Training Context} % Utvärdering, frågeställning 2
