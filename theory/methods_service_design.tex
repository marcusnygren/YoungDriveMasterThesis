...
\item Ideation, where you find possible ideas and when creation of a new version of the app is done, the \textit{Design phase}.
...
An example of an agile methodology is \textit{SCRUM}, where a project is divided into several iterations similar to a service design approach of sequencing, but also introducing concepts like retrospectives (reflecting on one's work) and sprint demo (demonstrating the results of the iteration to stakeholders) \citep{kniberg}.
